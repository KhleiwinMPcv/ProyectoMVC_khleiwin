...
class PagAdministrarNotasE extends StatefulWidget {
  final String codE;
  final String codc;
  final String prof;
  final String nombreUsuario;

  const PagAdministrarNotasE({
    required this.codE,
    required this.codc,
  ...
  @override
  _PagAdministrarNotasEState createState() => _PagAdministrarNotasEState();
}

class _PagAdministrarNotasEState extends State<PagAdministrarNotasE> {
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                      builder: (context) => PagCursosProfesorAdm(
                            codp: widget.prof,
                            adminPassword: widget.nombreUsuario,
                          )),
                );
              },
